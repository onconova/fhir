...
| Active as of 2025-11-18 | *Computable Name*:OnconovaTNMSerumTumorMarkerLevelCategory |
  ...
  "differential" : {
    "element" : [
        ...
        "constraint" : [
          {
            ...
            "source" : "http://onconova.github.io/fhir/StructureDefinition/onconova-serous-tumor-marker-level-category|0.2.0"
          },
          {
            "key" : "o-stg-req-2",
            "severity" : "error",
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://onconova.github.io/fhir/ValueSet/onconova-vs-tnm-serum-tumor-marker-level-categories|0.2.0"
        }
      }
    ]
  }
