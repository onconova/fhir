# TNM Serum Tumor Marker Level Category Profile - Onconova Implementation Guide v1.3.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **TNM Serum Tumor Marker Level Category Profile**

## Resource Profile: TNM Serum Tumor Marker Level Category Profile 

| | |
| :--- | :--- |
| *Official URL*:http://onconova.github.io/fhir/StructureDefinition/onconova-tnm-serum-tumor-marker-level-category | *Version*:1.3.0 |
| Active as of 2026-04-09 | *Computable Name*:OnconovaTNMSerumTumorMarkerLevelCategory |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/onconova.fhir|current/StructureDefinition/onconova-tnm-serum-tumor-marker-level-category)
...
Other representations of profile: [CSV](StructureDefinition-onconova-tnm-serum-tumor-marker-level-category.csv), [Excel](StructureDefinition-onconova-tnm-serum-tumor-marker-level-category.xlsx), [Schematron](StructureDefinition-onconova-tnm-serum-tumor-marker-level-category.sch) 
...
```json
{
  ...
  "url" : "http://onconova.github.io/fhir/StructureDefinition/onconova-tnm-serum-tumor-marker-level-category",
  "version" : "1.3.0",
  ...
  "differential" : {
    "element" : [{
      ...
      "constraint" : [{
        ...
        "source" : "http://onconova.github.io/fhir/StructureDefinition/onconova-tnm-serum-tumor-marker-level-category"
      },
      {
        "key" : "o-stg-req-2",
        "severity" : "error",
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "http://onconova.github.io/fhir/ValueSet/onconova-vs-tnm-serum-tumor-marker-level-categories"
      }
    },
    {
