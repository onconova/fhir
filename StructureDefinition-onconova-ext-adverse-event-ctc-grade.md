# Adverse Event CTCAE Grade - Onconova Implementation Guide v1.3.0
...
| | |
| :--- | :--- |
| *Official URL*:http://onconova.github.io/fhir/StructureDefinition/onconova-ext-adverse-event-ctc-grade | *Version*:1.3.0 |
| Active as of 2026-04-15 | *Computable Name*:AdverseEventCTCGrade |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/onconova.fhir|current/StructureDefinition/onconova-ext-adverse-event-ctc-grade)
...
Other representations of profile: [CSV](StructureDefinition-onconova-ext-adverse-event-ctc-grade.csv), [Excel](StructureDefinition-onconova-ext-adverse-event-ctc-grade.xlsx), [Schematron](StructureDefinition-onconova-ext-adverse-event-ctc-grade.sch) 
