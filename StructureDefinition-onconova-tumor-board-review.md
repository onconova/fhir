# Tumor Board Review Profile - Onconova Implementation Guide v1.4.0
...
| | |
| :--- | :--- |
| *Official URL*:http://onconova.github.io/fhir/StructureDefinition/onconova-tumor-board-review | *Version*:1.4.0 |
| Active as of 2026-04-26 | *Computable Name*:OnconovaTumorBoardReview |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://onconova.github.io/fhir/StructureDefinition/onconova-ext-tumor-board-specialization"]
      }],
      "mustSupport" : true
    },
    {
