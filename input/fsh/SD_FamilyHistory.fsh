...
* condition[cancerCondition].extension contains FamilyMemberConditionContributedToDeath named contributedToDeath 0..1 MS
...
Extension: FamilyMemberConditionContributedToDeath
