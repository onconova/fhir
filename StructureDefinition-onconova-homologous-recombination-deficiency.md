# Homologous Recombination Deficiency Profile - Onconova Implementation Guide v1.4.0
...
| | |
| :--- | :--- |
| *Official URL*:http://onconova.github.io/fhir/StructureDefinition/onconova-homologous-recombination-deficiency | *Version*:1.4.0 |
| Active as of 2026-04-26 | *Computable Name*:OnconovaHomologousRecombinationDeficiency |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://onconova.github.io/fhir/StructureDefinition/onconova-ext-homologous-recombination-deficiency-interpretation"]
      }],
      "mustSupport" : true
    },
    {
