# Molecular Tumor Board Therapeutic Recommendation - Onconova Implementation Guide v1.4.0
...
| | |
| :--- | :--- |
| *Official URL*:http://onconova.github.io/fhir/StructureDefinition/onconova-ext-molecular-tumor-board-therapeutic-recommendation | *Version*:1.4.0 |
| Active as of 2026-04-26 | *Computable Name*:MolecularTumorBoardTherapeuticRecommendation |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://onconova.github.io/fhir/StructureDefinition/onconova-tumor-marker",
