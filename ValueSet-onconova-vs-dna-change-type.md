# Coding DNA Change Type Value Set - Onconova Implementation Guide v0.2.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Coding DNA Change Type Value Set**

## ValueSet: Coding DNA Change Type Value Set 
...
```json
{
  ...
  "url" : "http://onconova.github.io/fhir/ValueSet/onconova-vs-dna-change-type",
  "version" : "0.2.0",
