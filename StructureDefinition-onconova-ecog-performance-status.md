# ECOG Performance Status Profile - Onconova Implementation Guide v1.3.0
...
| | |
| :--- | :--- |
| *Official URL*:http://onconova.github.io/fhir/StructureDefinition/onconova-ecog-performance-status | *Version*:1.3.0 |
| Active as of 2026-04-15 | *Computable Name*:OnconovaECOGPerformanceStatus |
...
```json
{
  ...
  "abstract" : false,
  "type" : "Observation",
  "baseDefinition" : "http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-ecog-performance-status",
  ...
  "differential" : {
    "element" : [{
      ...
      "constraint" : [{
        ...
        "source" : "http://onconova.github.io/fhir/StructureDefinition/onconova-ecog-performance-status"
      },
      {
        "key" : "o-obs-req-2",
        "severity" : "error",
