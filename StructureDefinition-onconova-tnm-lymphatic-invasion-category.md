# TNM Lymphatic Invasion Category - Onconova Implementation Guide v0.2.0
...
| Active as of 2025-10-17 | *Computable Name*:OnconovaTNMLymphaticInvasionCategory |
  ...
  "differential" : {
    "element" : [
        ...
        "constraint" : [
          {
            ...
            "source" : "http://onconova.github.io/fhir/StructureDefinition/onconova-tnm-lymphatic-invasion-category|0.2.0"
          },
          {
            "key" : "o-stg-req-2",
            "severity" : "error",
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://onconova.github.io/fhir/ValueSet/onconova-tnm-lymphatic-invasion-categories|0.2.0"
        }
      }
    ]
  }
