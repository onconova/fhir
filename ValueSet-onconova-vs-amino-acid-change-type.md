...
| | |
| :--- | :--- |
| *Official URL*:http://onconova.github.io/fhir/ValueSet/onconova-vs-amino-acid-change-type | *Version*:0.2.0 |
| Active as of 2025-11-21 | *Computable Name*:AminoAcidChangeTypeVS |
...
```json
{
  ...
  "url" : "http://onconova.github.io/fhir/ValueSet/onconova-vs-amino-acid-change-type",
  "version" : "0.2.0",
  "name" : "AminoAcidChangeTypeVS",
