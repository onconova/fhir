# Karnofsky Performance Status Profile - Onconova Implementation Guide v1.4.0
...
| | |
| :--- | :--- |
| *Official URL*:http://onconova.github.io/fhir/StructureDefinition/onconova-karnofsky-performance-status | *Version*:1.4.0 |
| Active as of 2026-04-26 | *Computable Name*:OnconovaKarnofskyPerformanceStatus |
...
```json
{
  ...
  "abstract" : false,
  "type" : "Observation",
  "baseDefinition" : "http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-karnofsky-performance-status",
  ...
  "differential" : {
    "element" : [{
      ...
      "constraint" : [{
        ...
        "source" : "http://onconova.github.io/fhir/StructureDefinition/onconova-karnofsky-performance-status"
      },
      {
        "key" : "o-obs-req-2",
        "severity" : "error",
