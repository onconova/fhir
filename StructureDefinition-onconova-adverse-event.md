# Adverse Event Profile - Onconova Implementation Guide v1.3.0
...
| | |
| :--- | :--- |
| *Official URL*:http://onconova.github.io/fhir/StructureDefinition/onconova-adverse-event | *Version*:1.3.0 |
| Active as of 2026-04-09 | *Computable Name*:OnconovaAdverseEvent |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://onconova.github.io/fhir/StructureDefinition/onconova-ext-adverse-event-ctc-grade"]
      }],
      "mustSupport" : true
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://onconova.github.io/fhir/StructureDefinition/onconova-ext-adverse-event-resolved-date"]
      }],
      "mustSupport" : true
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://onconova.github.io/fhir/StructureDefinition/onconova-ext-adverse-event-mitigation"]
      }],
      "mustSupport" : true
    },
    {
