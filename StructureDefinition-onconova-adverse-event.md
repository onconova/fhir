...
| | |
| :--- | :--- |
| *Official URL*:http://onconova.github.io/fhir/StructureDefinition/onconova-adverse-event | *Version*:0.1.0 |
| Active as of 2025-10-15 | *Computable Name*:OnconovaAdverseEvent |
  ...
  "differential" : {
    "element" : [
        ...
        "constraint" : [
          {
            ...
            "source" : "http://onconova.github.io/fhir/StructureDefinition/onconova-adverse-event|0.1.0"
          },
          {
            "key" : "date-required",
            "severity" : "error",
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "http://onconova.github.io/fhir/StructureDefinition/onconova-ext-ctc-grade|0.1.0"
            ]
          }
        ]
      },
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "http://onconova.github.io/fhir/StructureDefinition/onconova-ext-adverse-event-mitigation|0.1.0"
            ]
          }
        ]
      },
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://onconova.github.io/fhir/ValueSet/onconova-vs-ctc-adverse-events|0.1.0"
        }
      },
      {
